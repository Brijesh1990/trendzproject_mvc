                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="form-group has-success">
                                    <label class="col-lg-3 control-label">Select Main category</label>
                                    <div class="col-lg-6">
                                        <select name="catname" placeholder="" id="f-name" class="form-control">
                            ...
                            <div class="form-group has-success">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="subcatname" placeholder="" id="f-name" class="form-control">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-3 col-lg-6">
                                        <button class="btn btn-primary" type="submit" name="addsubcat">Add SubCategory!</button>
                                    </div>
                                </div>
                            </form>
                        </div>
