...
<!DOCTYPE html>
<head>
    <title>Addidas Shopping Admin Panel</title>
...
Trendz
    ...
    <div class="top-nav clearfix">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <img alt="" src="<?php echo $baseurl;?>images/adminprof.jpg">
                ...
                <ul class="dropdown-menu extended logout">
                    ...
                    <li><a href="<?php echo $mainurl;?>AdminDashboard?lgout" onclick="return confirm('Are You sure to logut ?')"><i class="fa fa-key"></i> Log Out</a></li>
                </ul>
            </li>
...
<script src="<?php echo $baseurl;?>js/bootstrap.js">
